...
translator_ldub_swap(CPUArchState *env, abi_ptr pc, bool do_swap)
{
...
static inline uint8_t translator_ldub(CPUArchState *env, abi_ptr pc)			
{																	
	return translator_ldub_swap(env, pc, false);						
}

static inline int16_t													
translator_ldsw_swap(CPUArchState *env, abi_ptr pc, bool do_swap)	
{																	
...
static inline int16_t translator_ldsw(CPUArchState *env, abi_ptr pc)			
{																	
	return translator_ldsw_swap(env, pc, false);						
}

static inline uint16_t													
translator_lduw_swap(CPUArchState *env, abi_ptr pc, bool do_swap)		
{																	
...
static inline uint16_t translator_lduw(CPUArchState *env, abi_ptr pc)			
{																	
	return translator_lduw_swap(env, pc, false);						
}

static inline uint32_t                                                  
translator_ldl_swap(CPUArchState *env, abi_ptr pc, bool do_swap)      
{                                                                   
...
static inline uint32_t translator_ldl(CPUArchState *env, abi_ptr pc)          
{                                                                   
    return translator_ldl_swap(env, pc, false);                       
}

static inline uint64_t													
translator_ldq_swap(CPUArchState *env, abi_ptr pc, bool do_swap)		
{																	
...
static inline uint64_t translator_ldq(CPUArchState *env, abi_ptr pc)			
{																	
	return translator_ldq_swap(env, pc, false);						
}

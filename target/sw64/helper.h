...
DEF_HELPER_FLAGS_2(fcvtws, TCG_CALL_NO_RWG, i64, env, i32)
DEF_HELPER_FLAGS_2(fcvtld, TCG_CALL_NO_RWG, i64, env, i64)
DEF_HELPER_FLAGS_2(fcvtwd, TCG_CALL_NO_RWG, i64, env, i32)
DEF_HELPER_FLAGS_2(cmovuls, TCG_CALL_NO_RWG, i64, env, i64)
DEF_HELPER_FLAGS_2(cmovuws, TCG_CALL_NO_RWG, i64, env, i32)
DEF_HELPER_FLAGS_2(cmovuld, TCG_CALL_NO_RWG, i64, env, i64)
DEF_HELPER_FLAGS_2(cmovuwd, TCG_CALL_NO_RWG, i64, env, i32)
DEF_HELPER_FLAGS_3(cmovdlu, TCG_CALL_NO_RWG, i64, env, i64, i64)
DEF_HELPER_FLAGS_2(cmovdlu_dyn, TCG_CALL_NO_RWG, i64, env, i64)

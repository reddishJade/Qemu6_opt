...
static call_native_func gen_helper_call_native_lib_GPR_VOID[] = {
    ...
    gen_helper_call_native_lib_GPR_VOID_2,
    gen_helper_call_native_lib_GPR_VOID_3,
    gen_helper_call_native_lib_GPR_VOID_4,
...
static call_native_func gen_helper_call_native_lib_FPR_VOID[] = {
    gen_helper_call_native_lib_FPR_VOID_0,
    gen_helper_call_native_lib_FPR_VOID_1,
    gen_helper_call_native_lib_FPR_VOID_2,
    gen_helper_call_native_lib_FPR_VOID_3,
    gen_helper_call_native_lib_FPR_VOID_4,
    gen_helper_call_native_lib_FPR_VOID_5,
...
static call_native_func gen_helper_call_native_lib_FPR_GPR_VOID[] = {
    gen_helper_call_native_lib_FPR_GPR_VOID_0,
    gen_helper_call_native_lib_FPR_GPR_VOID_1,
    gen_helper_call_native_lib_FPR_GPR_VOID_2,
    gen_helper_call_native_lib_FPR_GPR_VOID_3,
    gen_helper_call_native_lib_FPR_GPR_VOID_4,
};
#endif
...
static bool h264ref_oracle_top2(target_ulong site, target_ulong target[2])
{
    switch (site) {
    case 0x400003ab34ULL:
        target[0] = 0x400005dc10ULL;
        target[1] = 0x400005dc30ULL;
        return true;
    case 0x400003c4cbULL: case 0x400003c501ULL:
    case 0x400003c537ULL: case 0x400003c56cULL:
    case 0x400003c59dULL: case 0x400003c5ccULL:
    ...
    case 0x400003cd47ULL: case 0x400003cd75ULL:
    case 0x400003cda6ULL:
        target[0] = 0x400005dfe0ULL;
        target[1] = 0x400005df60ULL;
        return true;
    default:
        return false;
    }
...
static void gen_oracle_top2(DisasContext *s, TCGv dest)
{
    target_ulong target[2];
...
static inline void gen_op_ldl_a(DisasContext *s, int idx, TCGv t0, TCGv a0, TCGv tmp, int disp)
{
    tcg_gen_ldl_a_tl(t0, a0, s->mem_index, idx | MO_LE, tmp, disp);
...
#if defined(CONFIG_IROPT) && defined(__sw_64__)
static inline void gen_op_movl_T0_Dshift_add_reg_2(DisasContext *s, MemOp ot, MemOp size, int reg1, int reg2)
{
    bool s4 = (ot == 2) ? 1 : 0;
    bool s8 = (ot == 3) ? 1 : 0;
    tcg_gen_ld32s_tl(s->T0, cpu_env, offsetof(CPUX86State, df));
    if (s4) {
	tcg_gen_s4addl_i64(s->tmp0, s->T0, cpu_regs[reg1]);
        gen_op_mov_reg_v(s, size, reg1, s->tmp0);

	tcg_gen_s4addl_i64(s->tmp0, s->T0, cpu_regs[reg2]);
        gen_op_mov_reg_v(s, size, reg2, s->tmp0);
    }else if (s8) {
	tcg_gen_s8addl_i64(s->tmp0, s->T0, cpu_regs[reg1]);
        gen_op_mov_reg_v(s, size, reg1, s->tmp0);

	tcg_gen_s8addl_i64(s->tmp0, s->T0, cpu_regs[reg2]);
        gen_op_mov_reg_v(s, size, reg2, s->tmp0);
    }else{
        tcg_gen_shli_tl(s->T0, s->T0, ot);

        tcg_gen_add_tl(s->tmp0, cpu_regs[reg1], s->T0);
        gen_op_mov_reg_v(s, size, reg1, s->tmp0);

        tcg_gen_add_tl(s->tmp0, cpu_regs[reg2], s->T0);
        gen_op_mov_reg_v(s, size, reg2, s->tmp0);
   }
};
static inline void gen_op_movl_T0_Dshift_add_reg(DisasContext *s, MemOp ot, MemOp size, int reg)
{
    bool s4 = 0;
    bool s8 = 0;
    tcg_gen_ld32s_tl(s->T0, cpu_env, offsetof(CPUX86State, df));
    ...
    if (ot == 3) s8 = 1;
    if (s4) {
	tcg_gen_s4addl_i64(s->tmp0, s->T0, cpu_regs[reg]);
        gen_op_mov_reg_v(s, size, reg, s->tmp0);
    }else if (s8) {
	tcg_gen_s8addl_i64(s->tmp0, s->T0, cpu_regs[reg]);
        gen_op_mov_reg_v(s, size, reg, s->tmp0);
    }else{
        tcg_gen_shli_tl(s->T0, s->T0, ot);
        tcg_gen_add_tl(s->tmp0, cpu_regs[reg], s->T0);
...
#if defined(CONFIG_IROPT) && defined(__sw_64__)
    gen_op_movl_T0_Dshift_add_reg_2(s, ot, s->aflag, R_ESI, R_EDI);
#else
...
static inline void gen_stos(DisasContext *s, MemOp ot)
{
    ...
    gen_op_st_v(s, ot, s->T0, s->A0);
#if defined(CONFIG_IROPT) && defined(__sw_64__)
    gen_op_movl_T0_Dshift_add_reg(s, ot, s->aflag, R_EDI);
#else
    gen_op_movl_T0_Dshift(s, ot);
    gen_op_add_reg_T0(s, s->aflag, R_EDI);
#endif
...
#if defined(CONFIG_IROPT) && defined(__sw_64__)
    gen_op_movl_T0_Dshift_add_reg(s, ot, s->aflag, R_ESI);
#else
    gen_op_movl_T0_Dshift(s, ot);
    gen_op_add_reg_T0(s, s->aflag, R_ESI);
#endif
...
static TCGv gen_lea_modrm_1(DisasContext *s, AddressParts a)
{
    ...
    if (a.index >= 0) {
#if defined(CONFIG_IROPT) && defined(__sw_64__)
        bool s4 = a.scale == 2 ? 1 : 0;
        bool s8 = a.scale == 3 ? 1 : 0;
	    if(s4 || s8) {
            if (a.base >= 0) {
	            if(s4) tcg_gen_s4addl_i64(s->A0, cpu_regs[a.index], cpu_regs[a.base]);
	            if(s8) tcg_gen_s8addl_i64(s->A0, cpu_regs[a.index], cpu_regs[a.base]);
                ea = s->A0;
            } else {
...
#if defined(CONFIG_LDLA_OPT)
static MemOp gen_pop_opt(DisasContext *s, TCGv tmp, int disp)
{
    MemOp d_ot = mo_pushpop(s, s->dflag);

    gen_lea_v_seg(s, mo_stacksize(s), cpu_regs[R_ESP], R_SS, -1);
    gen_op_ldl_a(s, d_ot, s->T0, s->A0, tmp, disp);
    gen_op_mov_reg_v(s, d_ot, R_ESP, tmp);
    return d_ot;
}
#endif
...
#if defined(CONFIG_FUNC_OPT) && defined(__sw_64__)
bool func_opt_1(DisasContext *s, unsigned int b, unsigned int b1, bool para_same, int op1_offset, int op2_offset){

    tcg_debug_assert(op1_offset < 0x7fff && op1_offset > -0x8000);
    tcg_debug_assert(op2_offset < 0x7fff && op2_offset > -0x8000);
#if defined(CONFIG_FUNC_OPT3) && defined(__sw_64__)
    if (b == 0x74 && b1 == 1) {//pcmpeqb xmm
         for(int i = 0; i < 2; i++){
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
                tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
            }else{
                tcg_gen_ld_tl(s->T0, cpu_env, op1_offset + 8);
                tcg_gen_ld_tl(s->T1, cpu_env, op2_offset + 8);
            }
            for(int j = 0; j < 8; j++){
                tcg_gen_movi_tl(s->tmp0, 0b1<<j);
                if( j == 0){
                    tcg_gen_sub_tl(s->A0, s->T0, s->T1);
                    tcg_gen_zapnot(s->tmp4, s->A0, s->tmp0);
                    tcg_gen_cmpeqi_i64(s->tmp4, s->tmp4, 0);
                    tcg_gen_neg_i64(s->tmp4, s->tmp4);
                    tcg_gen_zapnot(s->tmp4, s->tmp4, s->tmp0);
                }else{
                    tcg_gen_zapnot(s->A0, s->T0, s->tmp0);
                    tcg_gen_zapnot(s->tmp1_i64, s->T1, s->tmp0);
                    tcg_gen_sub_tl(s->A0, s->A0, s->tmp1_i64);
                    tcg_gen_cmpeqi_i64(s->A0, s->A0, 0);
                    tcg_gen_neg_i64(s->A0, s->A0);
                    tcg_gen_zapnot(s->A0, s->A0, s->tmp0);
                    tcg_gen_or_tl(s->tmp4, s->tmp4, s->A0);
                }
            }
            if(i == 0){
                tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset);
            }else{
                tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset + 8);
            }
        }
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT4) && defined(__sw_64__)
    if((b == 0x57) ||(b ==0xef && b1 ==1)) {//pxor-0x57
        if(para_same){
            tcg_gen_movi_tl(s->T0, 0);
            tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
            tcg_gen_st_tl(s->T0, cpu_env, op1_offset + 8);
        }else{
            tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
            tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
...
#endif
#if defined(CONFIG_FUNC_OPT5) && defined(__sw_64__)
	if(b == 0xf8 && b1 == 1){ //psubb_xmm
		for(int i = 0; i < 16; i++) {
            tcg_gen_ld8u_tl(s->T0, cpu_env, op1_offset + i);
            tcg_gen_ld8u_tl(s->T1, cpu_env, op2_offset + i);
            tcg_gen_sub_tl(s->T0, s->T0, s->T1);
            tcg_gen_ext8u_tl(s->T0, s->T0);
            tcg_gen_st8_tl(s->T0, cpu_env, op1_offset + i);
        }
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT6) && defined(__sw_64__)
    if(b == 0x56 || (b == 0xeb && b1 == 1)) {//por_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
        tcg_gen_or_tl(s->T0, s->T0, s->T1);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
...
#endif
#if defined(CONFIG_FUNC_OPT7) && defined(__sw_64__)
    if( b == 0x54 || (b == 0xdb && b1 == 1)) {//pand_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
    ...
    if( b == 0x58 ) {
        switch(b1) {
#if defined(CONFIG_FUNC_OPT8) && defined(__sw_64__)
        case 0://addps
            for (int i=0;i<4;i++) {
                tcg_gen_flds(s->f64, cpu_env, op1_offset + i*4);
                tcg_gen_flds(s->f64_1, cpu_env, op2_offset + i*4);
                tcg_gen_fadds(s->f64_1, s->f64_1, s->f64);
                tcg_gen_fsts(s->f64_1, cpu_env, op1_offset + i*4);
            }
            break;
#endif
#if defined(CONFIG_FUNC_OPT23) && defined(__sw_64__)
        case 1://addpd
            tcg_gen_fldd(s->f64, cpu_env, op1_offset);
            tcg_gen_fldd(s->f64_1, cpu_env, op2_offset);
            tcg_gen_faddd(s->f64_1, s->f64_1, s->f64);
            tcg_gen_fstd(s->f64_1, cpu_env, op1_offset);
            tcg_gen_fldd(s->f64, cpu_env, op1_offset + 8);
            tcg_gen_fldd(s->f64_1, cpu_env, op2_offset + 8);
            tcg_gen_faddd(s->f64_1, s->f64_1, s->f64);
            tcg_gen_fstd(s->f64_1, cpu_env, op1_offset + 8);
            break;
#endif
#if defined(CONFIG_FUNC_OPT9) && defined(__sw_64__)
        case 2://addss
            tcg_gen_flds(s->f64, cpu_env, op1_offset);
            tcg_gen_flds(s->f64_1, cpu_env, op2_offset);
            tcg_gen_fadds(s->f64_1, s->f64_1, s->f64);
            tcg_gen_fsts(s->f64_1, cpu_env, op1_offset);
            break;
#endif
#if defined(CONFIG_FUNC_OPT10) && defined(__sw_64__)
        case 3://addsd
            tcg_gen_fldd(s->f64, cpu_env, op1_offset);
            tcg_gen_fldd(s->f64_1, cpu_env, op2_offset);
            tcg_gen_faddd(s->f64_1, s->f64_1, s->f64);
...
#if defined(CONFIG_FUNC_OPT11) && defined(__sw_64__)
    if( b == 0x5c && b1 == 3 ) {//subsd
        tcg_gen_fldd(s->f64, cpu_env, op1_offset);
        tcg_gen_fldd(s->f64_1, cpu_env, op2_offset);
        tcg_gen_fsubd(s->f64_1, s->f64_1, s->f64);
        tcg_gen_fstd(s->f64_1, cpu_env, op1_offset);
        return true;
    }
#endif
    if( b == 0x59 ) {
        switch(b1) {
#if defined(CONFIG_FUNC_OPT12) && defined(__sw_64__)
        case 0://mulps
            for (int i=0;i<4;i++){
                tcg_gen_flds(s->f64, cpu_env, op1_offset + i*4);
                tcg_gen_flds(s->f64_1, cpu_env, op2_offset + i*4);
                tcg_gen_fmuls(s->f64_1, s->f64_1, s->f64);
                tcg_gen_fsts(s->f64_1, cpu_env, op1_offset + i*4);
            }
            break;
#endif
#if defined(CONFIG_FUNC_OPT13) && defined(__sw_64__)
        case 3://mulsd
            tcg_gen_fldd(s->f64, cpu_env, op1_offset);
            tcg_gen_fldd(s->f64_1, cpu_env, op2_offset);
            tcg_gen_fmuld(s->f64_1, s->f64_1, s->f64);
            tcg_gen_fstd(s->f64_1, cpu_env, op1_offset);
            break;
#endif
        default:
...
#if defined(CONFIG_FUNC_OPT14) && defined(__sw_64__)
//tianx add: WeChat is not using this piece of code.
    if( b == 0xd2 && b1 == 1 ) {//psrld_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op2_offset);
        tcg_gen_brcondi_tl(TCG_COND_LE, s->tmp0, 31, label1);
        tcg_gen_movi_tl(s->T0, 0);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset + 8);
        tcg_gen_br(label2);
        gen_set_label(label1);
        tcg_gen_ld8u_tl(s->tmp0, cpu_env, op2_offset);
        for (int i=0;i<4;i++) {
            tcg_gen_ld32u_tl(s->T0, cpu_env, op1_offset + i*4);
            tcg_gen_shr_tl(s->T0, s->T0, s->tmp0);
            tcg_gen_st32_tl(s->T0, cpu_env, op1_offset + i*4);
        }
        gen_set_label(label2);
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT15) && defined(__sw_64__)
//tianx add: WeChat is not using this piece of code.
    if( b == 0xf2 && b1 == 1 ) {//pslld_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op2_offset);
        ...
        for (int i=0;i<4;i++) {
            tcg_gen_ld32u_tl(s->T0, cpu_env, op1_offset + i*4);
            tcg_gen_shl_tl(s->T0, s->T0, s->tmp0);
            tcg_gen_st32_tl(s->T0, cpu_env, op1_offset + i*4);
        }
        gen_set_label(label2);
        return true;
...
#endif
#if defined(CONFIG_FUNC_OPT16) && defined(__sw_64__)
    if( b == 0xfe && b1 == 1 ) {//paddl_xmm
        for (int i=0;i<2;i++) {
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
                tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
            ...
            tcg_gen_add_i64(s->tmp4, s->T0, s->T1);
            tcg_gen_movi_tl(s->A0, 0b1111<<(0*2));
            tcg_gen_zapnot(s->tmp0, s->tmp4, s->A0);
            tcg_gen_movi_tl(s->A0, 0b1111<<(2*2));
            tcg_gen_zapnot(s->tmp4, s->T0, s->A0);
            tcg_gen_zapnot(s->tmp1_i64, s->T1, s->A0);
            tcg_gen_add_i64(s->tmp4, s->tmp4, s->tmp1_i64);
            tcg_gen_or_tl(s->tmp4, s->tmp0, s->tmp4);
            if(i == 0){
                tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset);
            }else{
                tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset + 8);
...
#endif
#if defined(CONFIG_FUNC_OPT17) && defined(__sw_64__)
    if( b == 0xd4 && b1 == 1 ) {//paddq_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
...
#endif
#if defined(CONFIG_FUNC_OPT18) && defined(__sw_64__)
    if( b == 0xfb && b1 == 1 ) {//psubq_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
        tcg_gen_sub_i64(s->T0, s->T0, s->T1);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset + 8);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset + 8);
        tcg_gen_sub_i64(s->T0, s->T0, s->T1);
...
#endif
#if defined(CONFIG_FUNC_OPT19) && defined(__sw_64__)
    if( b == 0xf4 && b1 == 1 ) {//pmuludq_xmm
        tcg_gen_ld32u_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld32u_tl(s->T1, cpu_env, op2_offset);
        tcg_gen_mul_i64(s->T0, s->T0, s->T1);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld32u_tl(s->T0, cpu_env, op1_offset + 8);
        tcg_gen_ld32u_tl(s->T1, cpu_env, op2_offset + 8);
        tcg_gen_mul_i64(s->T0, s->T0, s->T1);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset + 8);
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT20) && defined(__sw_64__)
    if( b == 0x60 && b1 == 1 ) {//punpcklbw_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
        for (int i=0; i < 4 ;i++) {
            tcg_gen_movi_tl(s->tmp1_i64, 1<<i);
            if (i == 0) {
                tcg_gen_zapnot(s->tmp4, s->T0, s->tmp1_i64);
            } else {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shli_tl(s->tmp0, s->tmp0, i*8);
                tcg_gen_or_tl(s->tmp4, s->tmp0, s->tmp4);
            }

            tcg_gen_zapnot(s->tmp0, s->T1, s->tmp1_i64);
            tcg_gen_shli_tl(s->tmp0, s->tmp0, (i+1)*8);
            tcg_gen_or_tl(s->tmp4, s->tmp0, s->tmp4);
        }
        tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset);
        for (int i=4; i < 8 ;i++) {
            ...
            if (i == 4) {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shri_tl(s->A0, s->tmp0, (8-i)*8);
            } else {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shri_tl(s->tmp0, s->tmp0, (8-i)*8);
                tcg_gen_or_tl(s->A0, s->tmp0, s->A0);
            }

            tcg_gen_zapnot(s->tmp0, s->T1, s->tmp1_i64);
            if (i != 7)
                tcg_gen_shri_tl(s->tmp0, s->tmp0, (7-i)*8);
            tcg_gen_or_tl(s->A0, s->tmp0, s->A0);
        }
        tcg_gen_st_tl(s->A0, cpu_env, op1_offset+8);
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT21) && defined(__sw_64__)
    if( b == 0x61 && b1 == 1 ) {//punpcklwd_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
        for (int i=0; i < 2 ;i++) {
            tcg_gen_movi_tl(s->tmp1_i64, 0b11<<(i*2));
            if (i == 0) {
                tcg_gen_zapnot(s->tmp4, s->T0, s->tmp1_i64);
            } else {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shli_tl(s->tmp0, s->tmp0, i*16);
                tcg_gen_or_tl(s->tmp4, s->tmp0, s->tmp4);
            }

            tcg_gen_zapnot(s->tmp0, s->T1, s->tmp1_i64);
            tcg_gen_shli_tl(s->tmp0, s->tmp0, (i+1)*16);
            tcg_gen_or_tl(s->tmp4, s->tmp0, s->tmp4);
        }
        tcg_gen_st_tl(s->tmp4, cpu_env, op1_offset);
        for (int i=2; i < 4 ;i++) {
            ...
            if (i == 2) {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shri_tl(s->A0, s->tmp0, (4-i)*16);
            } else {
                tcg_gen_zapnot(s->tmp0, s->T0, s->tmp1_i64);
                tcg_gen_shri_tl(s->tmp0, s->tmp0, (4-i)*16);
                tcg_gen_or_tl(s->A0, s->tmp0, s->A0);
            }

            tcg_gen_zapnot(s->tmp0, s->T1, s->tmp1_i64);
            if (i != 3)
                tcg_gen_shri_tl(s->tmp0, s->tmp0, (3-i)*16);
            tcg_gen_or_tl(s->A0, s->tmp0, s->A0);
        }
        tcg_gen_st_tl(s->A0, cpu_env, op1_offset+8);
        return true;
...
#endif
#if defined(CONFIG_FUNC_OPT22) && defined(__sw_64__)
    if(b == 0xd7 || b == 0x1d7){//pmovmskb
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset + 8);
        for (int i = 0; i < 8; i++) {
            if (i == 0) {
                tcg_gen_shri_tl(s->T0, s->T0, 7);
                tcg_gen_andi_tl(s->tmp2_i32, s->T0, 1);
            } else {
                tcg_gen_shri_tl(s->T0, s->T0, 7);
                tcg_gen_andi_tl(s->T1, s->T0, 1 << i);
                tcg_gen_or_tl(s->tmp2_i32, s->tmp2_i32, s->T1);
            }
        }
        tcg_gen_shli_tl(s->tmp2_i32, s->tmp2_i32, 8);
        tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
        for (int i = 0; i < 8; i++) {
            tcg_gen_shri_tl(s->T0, s->T0, 7);
            tcg_gen_andi_tl(s->T1, s->T0, 1 << i);
...
#endif
#if defined(CONFIG_FUNC_OPT28) && defined(__sw_64__)
    if( b == 0x62 && b1 == 1 ) {//punpckldq_xmm
        tcg_gen_ld_tl(s->T0, cpu_env, op2_offset);
        tcg_gen_ld32u_tl(s->T1, cpu_env, op1_offset + 4);
        tcg_gen_st32_tl(s->T0, cpu_env, op1_offset + 4);
        tcg_gen_movi_tl(s->A0, 0b1111<<(2*2));
        tcg_gen_zapnot(s->T0, s->T0, s->A0);
        tcg_gen_or_tl(s->T0, s->T0, s->T1);
        tcg_gen_st_tl(s->T0, cpu_env, op1_offset + 8);
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT33) && defined(__sw_64__)
    if( b == 0xfd && b1 == 1 ) {//paddw_xmm
        for(int i = 0; i < 2; i++){
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
                tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
            ...
            for(int j = 0; j < 4; j++){
                if(j == 0){
                    tcg_gen_movi_tl(s->tmp1_i64, 0b11<<(j*2));
                    tcg_gen_add_i64(s->tmp4, s->T0, s->T1);
                    tcg_gen_zapnot(s->tmp0, s->tmp4, s->tmp1_i64);
                }else{
                    tcg_gen_movi_tl(s->tmp1_i64, 0b11<<(j*2));
                    tcg_gen_zapnot(s->A0, s->T0, s->tmp1_i64);
                    tcg_gen_zapnot(s->tmp4, s->T1, s->tmp1_i64);
                    tcg_gen_add_i64(s->tmp4, s->A0, s->tmp4);
                    if (j != 3) tcg_gen_zapnot(s->tmp4, s->tmp4, s->tmp1_i64);
                    tcg_gen_or_tl(s->tmp0, s->tmp0, s->tmp4);
                }
            }
            if(i == 0){
                tcg_gen_st_tl(s->tmp0, cpu_env, op1_offset);
            }else{
                tcg_gen_st_tl(s->tmp0, cpu_env, op1_offset + 8);
            }
        }
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT34) && defined(__sw_64__)
    if( b == 0xd5 && b1 == 1 ) {//pmullw_xmm
        for(int i = 0; i < 2; i++){
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op1_offset);
                tcg_gen_ld_tl(s->T1, cpu_env, op2_offset);
            ...
            tcg_gen_movi_tl(s->tmp1_i64, 0b11<<(0*2));
            tcg_gen_mul_i64(s->tmp0, s->T0, s->T1);
            tcg_gen_zapnot(s->tmp0, s->tmp0, s->tmp1_i64);
            for(int j = 1; j < 4; j++){
                tcg_gen_shri_tl(s->A0, s->T0, 16*j);
                tcg_gen_shri_tl(s->tmp4, s->T1, 16*j);
                tcg_gen_mul_i64(s->A0, s->A0, s->tmp4);
                tcg_gen_shli_tl(s->A0, s->A0, 16*j);
                tcg_gen_movi_tl(s->tmp1_i64, 0b11<<(j*2));
                tcg_gen_zapnot(s->A0, s->A0, s->tmp1_i64);
                tcg_gen_or_tl(s->tmp0, s->tmp0, s->A0);
            }
            if(i == 0){
                tcg_gen_st_tl(s->tmp0, cpu_env, op1_offset);
            }else{
...
#endif
#if defined(CONFIG_FUNC_OPT35) && defined(__sw_64__)
    if( b == 0x5b ) {
        switch(b1) {
        case 0:   //cvtdq2ps
            for(int i = 0; i < 4; i++){
                ...
                if(i == 1 || i == 3){
                    tcg_gen_shri_tl(s->T0, s->T0, 32);
                }
                if(i == 2){
                    tcg_gen_ld_tl(s->T0, cpu_env, op2_offset + 8);
                }
        //      tcg_gen_trunc_tl_i32(s->tmp2_i32, s->T0);
                tcg_gen_ifmovd(s->f64, s->T0);
                tcg_gen_fcvtld(s->f64, s->f64);
                tcg_gen_fcvtds(s->f64_32, s->f64);
                tcg_gen_fsts(s->f64_32, cpu_env, op1_offset + i * 4);
            }
            break;
        case 1:    //cvtps2dq
            for(int i = 0; i < 2; i++){
                if( i == 0){
                    tcg_gen_flds(s->f64, cpu_env, op2_offset);
                }else{
                    tcg_gen_flds(s->f64, cpu_env, op2_offset + 2*4);
                }
                tcg_gen_fimovs(s->T0, s->f64);
                tcg_gen_ext32u_i64(s->T0, s->T0);
                if( i == 0){
                    tcg_gen_flds(s->f64, cpu_env, op2_offset + 1*4);
                }else{
                    tcg_gen_flds(s->f64, cpu_env, op2_offset + 3*4);
                }
                tcg_gen_fimovs(s->T1, s->f64);
                tcg_gen_shli_tl(s->T1, s->T1, 32);
                tcg_gen_or_tl(s->T1, s->T1, s->T0);
                if( i == 0){
                    tcg_gen_st_tl(s->T1, cpu_env, op1_offset);
                }else{
                    tcg_gen_st_tl(s->T1, cpu_env, op1_offset + 8);
                }
            }
            break;
        case 2:    //cvttps2dq
            for(int i = 0; i < 4; i++){
                tcg_gen_flds(s->f64, cpu_env, op2_offset + i*4);
                tcg_gen_fcvtsd(s->f64_1, s->f64);
                tcg_gen_fcvtdl_z(s->f64_1, s->f64_1);
                if(i == 0 || i == 2){
                    tcg_gen_fimovd(s->T0, s->f64_1);
                    tcg_gen_ext32u_i64(s->T0, s->T0);
                }else{
                    tcg_gen_fimovd(s->T1, s->f64_1);
                    tcg_gen_shli_tl(s->T1, s->T1, 32);
                    tcg_gen_or_tl(s->T1, s->T1, s->T0);
                }
                if(i == 1){
...
bool func_opt_2(DisasContext *s, unsigned int b, int op, MemOp ot) {
#if defined(CONFIG_FUNC_OPT24) && defined(__sw_64__)
    if(b == 0xf7 && op == 6 && ot == MO_32) { //divl
        TCGv_i64 num, den, quo, rem;
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        den = tcg_temp_local_new_i64();
        tcg_gen_mov_tl(den, s->T0);
        tcg_gen_brcondi_i64(TCG_COND_EQ, s->T0, 0, label1);
        num = tcg_temp_local_new_i64();
        quo = tcg_temp_local_new_i64();
        tcg_gen_concat_i32_i64(num, cpu_regs[R_EAX], cpu_regs[R_EDX]);
        tcg_gen_udivl_i64(quo, num, den);
        tcg_gen_brcondi_i64(TCG_COND_GTU, quo, 0xffffffffu, label1);
        rem = tcg_temp_new_i64();
        tcg_gen_ureml_i64(rem, num, den);
        tcg_gen_andi_i64(cpu_regs[R_EAX], quo, 0xffffffffu);
        tcg_gen_andi_i64(cpu_regs[R_EDX], rem, 0xffffffffu);
        tcg_gen_br(label2);
        gen_set_label(label1);
        gen_helper_divl_EAX(cpu_env, den);
        gen_set_label(label2);
        tcg_temp_free_i64(num);
        tcg_temp_free_i64(den);
        tcg_temp_free_i64(quo);
        tcg_temp_free_i64(rem);
        return true;
    }
#endif
...
bool func_opt_3(DisasContext *s, unsigned int item, unsigned int b1, bool para_same, int op1_offset, int op2_offset){

#if defined(CONFIG_FUNC_OPT14) && defined(__sw_64__)
    if( (item == (8 + 2)) && b1 == 1 ) {      //psrld_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op1_offset);
        tcg_gen_brcondi_tl(TCG_COND_LE, s->tmp0, 31, label1);
        tcg_gen_movi_tl(s->T0, 0);
        tcg_gen_st_tl(s->T0, cpu_env, op2_offset);
        tcg_gen_st_tl(s->T0, cpu_env, op2_offset + 8);
        tcg_gen_br(label2);
        gen_set_label(label1);
        tcg_gen_ld8u_tl(s->tmp0, cpu_env, op1_offset);
        for(int i = 0; i<2; i++){
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op2_offset);
            }else{
            ...
            tcg_gen_movi_tl(s->tmp1_i64, 0b1111<<(0*2));
            tcg_gen_zapnot(s->T1, s->T0, s->tmp1_i64);
            tcg_gen_shr_tl(s->tmp4, s->T1, s->tmp0);
            tcg_gen_movi_tl(s->tmp1_i64, 0b1111<<(2*2));
            tcg_gen_shr_tl(s->T1, s->T0, s->tmp0);
            tcg_gen_zapnot(s->T1, s->T1, s->tmp1_i64);
            tcg_gen_or_tl(s->tmp4, s->T1, s->tmp4);
            if(i == 0){
                tcg_gen_st_tl(s->tmp4, cpu_env, op2_offset);
            }else{
                tcg_gen_st_tl(s->tmp4, cpu_env, op2_offset + 8);
            }
        }
        gen_set_label(label2);
        return true;
    ...
    if( (item == (8 + 6)) && b1 == 1 ) {     //pslld_xmm
        ...
        for(int i = 0; i<2; i++){
            ...
            tcg_gen_movi_tl(s->tmp1_i64, 0b1111<<(0*2));
            tcg_gen_shl_tl(s->tmp4, s->T0, s->tmp0);
            tcg_gen_zapnot(s->tmp4, s->tmp4, s->tmp1_i64);
            tcg_gen_movi_tl(s->tmp1_i64, 0b1111<<(2*2));
            tcg_gen_zapnot(s->T1, s->T0, s->tmp1_i64);
            tcg_gen_shl_tl(s->T1, s->T1, s->tmp0);
            tcg_gen_or_tl(s->tmp4, s->T1, s->tmp4);
            if(i == 0){
                tcg_gen_st_tl(s->tmp4, cpu_env, op2_offset);
            }else{
...
#endif
#if defined(CONFIG_FUNC_OPT29) && defined(__sw_64__)
    if( (item == (8 + 4)) && b1 == 1 ) {     //psrad_xmm
        TCGv_i64 shift;
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        ...
        tcg_gen_ld_tl(s->tmp0, cpu_env, op1_offset);
        tcg_gen_brcondi_tl(TCG_COND_LE, s->tmp0, 31, label1);
        tcg_gen_movi_tl(shift, 31);
        tcg_gen_br(label2);
        gen_set_label(label1);
        tcg_gen_ld8u_tl(shift, cpu_env, op1_offset);
        gen_set_label(label2);
        for(int i=0; i<2; i++){
            if(i == 0){
                tcg_gen_ld_tl(s->T0, cpu_env, op2_offset);
            ...
            tcg_gen_ext32s_i64(s->T1, s->T0);
            tcg_gen_shr_tl(s->T1, s->T1, shift);
            tcg_gen_movi_tl(s->tmp1_i64, 0b1111<<(0*2));
            tcg_gen_zapnot(s->tmp4, s->T1, s->tmp1_i64);
            ...
            tcg_gen_ext32s_i64(s->T1, s->T0);
            tcg_gen_shr_tl(s->T1, s->T1, shift);
            tcg_gen_shli_tl(s->T0, s->T1, 32);
            tcg_gen_or_tl(s->tmp4, s->tmp4, s->T0);
            if(i == 0){
                tcg_gen_st_tl(s->tmp4, cpu_env, op2_offset);
            }else{
                tcg_gen_st_tl(s->tmp4, cpu_env, op2_offset + 8);
...
#endif
#if defined(CONFIG_FUNC_OPT30) && defined(__sw_64__)
    if( (item == (16 + 2)) && b1 == 1 ) {     //psrlq_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op1_offset);
        tcg_gen_brcondi_tl(TCG_COND_LE, s->tmp0, 63, label1);
        tcg_gen_movi_tl(s->tmp0, 0);
        tcg_gen_st_tl(s->tmp0, cpu_env, op2_offset);
        tcg_gen_st_tl(s->tmp0, cpu_env, op2_offset + 8);
        tcg_gen_br(label2);
        gen_set_label(label1);
        tcg_gen_ld8u_tl(s->tmp0, cpu_env, op1_offset);
        for (int i=0;i<2;i++) {
            tcg_gen_ld_tl(s->T0, cpu_env, op2_offset + i*8);
            tcg_gen_shr_tl(s->T0, s->T0, s->tmp0);
            tcg_gen_st_tl(s->T0, cpu_env, op2_offset + i*8);
        }
        gen_set_label(label2);
        return true;
    }
#endif
#if defined(CONFIG_FUNC_OPT31) && defined(__sw_64__)
    if( (item == (0 + 6)) && b1 == 1 ) {     //psllw_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op1_offset);
        tcg_gen_brcondi_tl(TCG_COND_LE, s->tmp0, 15, label1);
        tcg_gen_movi_tl(s->tmp0, 0);
        tcg_gen_st_tl(s->tmp0, cpu_env, op2_offset);
        tcg_gen_st_tl(s->tmp0, cpu_env, op2_offset + 8);
        tcg_gen_br(label2);
        ...
        for(int i = 0; i < 2; i++){
            ...
            for(int j = 0; j < 4; j++){
                if(j == 0){
                    ...
                    tcg_gen_zapnot(s->T1, s->T0, s->tmp1_i64);
                    tcg_gen_shl_tl(s->T1, s->T1, s->tmp0);
                    if(j != 3)  tcg_gen_zapnot(s->T1, s->T1, s->tmp1_i64);
                    tcg_gen_or_tl(s->tmp4, s->T1, s->tmp4);
                }
            }
            if(i == 0){
...
#endif
#if defined(CONFIG_FUNC_OPT32) && defined(__sw_64__)
    if( (item == (0 + 2)) && b1 == 1 ) {     //psrlw_xmm
        TCGLabel *label1, *label2;
        label1 = gen_new_label();
        label2 = gen_new_label();
        tcg_gen_ld_tl(s->tmp0, cpu_env, op1_offset);
            ...
            for(int j = 0; j < 4; j++){
                if(j == 0){
                    ...
                    if (j == 3) {
                        ...
                        tcg_gen_zapnot(s->T1, s->T0, s->tmp1_i64);
                        tcg_gen_shr_tl(s->T1, s->T1, s->tmp0);
                    }
                    tcg_gen_zapnot(s->T1, s->T1, s->tmp1_i64);
                    tcg_gen_or_tl(s->tmp4, s->T1, s->tmp4);
                }
                    ...
                    target_ulong pc_start, int rex_r)
{
    ...
    if (sse_fn_epp == SSE_SPECIAL) {
        ...
        case 0x16e: /* movd xmm, ea */
...
#if defined(CONFIG_FUNC_OPT0) && defined(__sw_64__)
                tcg_gen_ifmovd(s->vec128, s->T0);
                tcg_gen_st_i128(s->vec128, cpu_env, offsetof(CPUX86State,xmm_regs[reg]));
#else
            ...
            {
                gen_ldst_modrm(env, s, modrm, MO_32, OR_TMP0, 0);
#if defined(CONFIG_FUNC_OPT25) && defined(__sw_64__)
                tcg_gen_movi_tl(s->T1,0);
                tcg_gen_st_i64(s->T1, cpu_env, offsetof(CPUX86State, xmm_regs[reg].ZMM_Q(1)));
                tcg_gen_ext32u_tl(s->tmp0, s->T0);
                tcg_gen_st_i64(s->tmp0, cpu_env, offsetof(CPUX86State, xmm_regs[reg].ZMM_Q(0)));
#else
                tcg_gen_addi_ptr(s->ptr0, cpu_env,
                                 offsetof(CPUX86State,xmm_regs[reg]));
                tcg_gen_trunc_tl_i32(s->tmp2_i32, s->T0);
...
#if defined(CONFIG_FUNC_OPT) && defined(__sw_64__)
            para_same = (op1_offset==op2_offset)? true : false;
            bool result = func_opt_3(s, ((b - 1) & 3) * 8 + (((modrm >> 3)) & 7), b1, para_same, op1_offset, op2_offset);
            if(!result ){
                tcg_gen_addi_ptr(s->ptr0, cpu_env, op2_offset);
                tcg_gen_addi_ptr(s->ptr1, cpu_env, op1_offset);
                sse_fn_epp(cpu_env, s->ptr0, s->ptr1);
        ...
        case 0x150: /* movmskpd */
            rm = (modrm & 7) | REX_B(s);
#if defined(CONFIG_FUNC_OPT26) && defined(__sw_64__)
            tcg_gen_ld32s_tl(s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[rm].ZMM_L(1)));
            tcg_gen_movi_i64(s->A0, 31);
            tcg_gen_shr_tl(s->T0, s->T0, s->A0);
            tcg_gen_ld32s_tl(s->T1, cpu_env, offsetof(CPUX86State,xmm_regs[rm].ZMM_L(3)));
            tcg_gen_shr_tl(s->T1, s->T1, s->A0);
            tcg_gen_movi_i64(s->A0, 1);
            tcg_gen_shl_tl(s->T1, s->T1, s->A0);
            tcg_gen_or_i64(cpu_regs[reg], s->T0, s->T1);
#else
            tcg_gen_addi_ptr(s->ptr0, cpu_env,
                             offsetof(CPUX86State,xmm_regs[rm]));
        ...
        case 0x32a: /* cvtsi2sd */
            ...
            tcg_gen_addi_ptr(s->ptr0, cpu_env, op1_offset);
            if (ot == MO_32) {
#if defined(CONFIG_FUNC_OPT1) && defined(__sw_64__) //gaoqing
                tcg_gen_trunc_tl_i32(s->tmp2_i32, s->T0);
                tcg_gen_ifmovd(s->f64, s->tmp2_i32);
                tcg_gen_fcvtld(s->f64, s->f64);
                if (!((b >> 8) & 1)) {
                    tcg_gen_fcvtds(s->f64_32, s->f64);
                    tcg_gen_fsts(s->f64_32, s->ptr0, 0);
                } else {
                    tcg_gen_fstd(s->f64, s->ptr0, 0);
                }
#else
...
#ifdef TARGET_X86_64
#if defined(CONFIG_FUNC_OPT1) && defined(__sw_64__)
                tcg_gen_ifmovd(s->f64, s->T0);
                tcg_gen_fcvtld(s->f64, s->f64);
                if (!((b >> 8) & 1)) {
                    tcg_gen_fcvtds(s->f64_32, s->f64);
        ...
        case 0x1d7:
            ...
            if (b1) {
                rm = (modrm & 7) | REX_B(s);
#if defined(CONFIG_FUNC_OPT22) && defined(__sw_64__)
                op1_offset = offsetof(CPUX86State, xmm_regs[rm]);
                func_opt_1(s, b, b1, 0, op1_offset, 0);
#else
                tcg_gen_addi_ptr(s->ptr0, cpu_env,
                                 offsetof(CPUX86State, xmm_regs[rm]));
                ...
                rm = (modrm & 7);
#if defined(CONFIG_FUNC_OPT22) && defined(__sw_64__)
                op1_offset = offsetof(CPUX86State, fpregs[rm].mmx);
                func_opt_1(s, b, b1, 0, op1_offset, 0);
#else
                tcg_gen_addi_ptr(s->ptr0, cpu_env,
                                 offsetof(CPUX86State, fpregs[rm].mmx));
        ...
        case 0xc6: /* pshufx insn */
            val = x86_ldub_code(env, s);
#if defined(CONFIG_FUNC_OPT2) && defined(__sw_64__)
            if (b1 == 0) {//shufps
                tcg_gen_ld32u_tl(s->T0, cpu_env, op1_offset + (val & 3) * 4);
                tcg_gen_ld32s_tl(s->T1, cpu_env, op1_offset + ((val >> 2) & 3) * 4);
                tcg_gen_shli_tl(s->T1, s->T1, 32);
                tcg_gen_or_tl(s->T0, s->T0, s->T1);
                tcg_gen_st_tl(s->T0, cpu_env, op1_offset);

                tcg_gen_ld32u_tl(s->T0, cpu_env, op2_offset + ((val >> 4) & 3) * 4);
                tcg_gen_ld32s_tl(s->T1, cpu_env, op2_offset + ((val >> 6) & 3) * 4);
                tcg_gen_shli_tl(s->T1, s->T1, 32);
                tcg_gen_or_tl(s->T0, s->T0, s->T1);
                tcg_gen_st_tl(s->T0, cpu_env, op1_offset + 8);
                break;
...
#endif
#if defined(CONFIG_FUNC_OPT27) && defined(__sw_64__)
            if (b1 == 1) {//pshufd_xmm
                if(val == 0){
                    tcg_gen_ld32u_tl(s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[rm].ZMM_L(0)));
                    tcg_gen_shli_tl(s->T1, s->T0, 32);
                    tcg_gen_or_tl(s->T0, s->T0, s->T1);
                    tcg_gen_st_tl(s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_Q(1)));
                    tcg_gen_st_tl(s->T0, cpu_env, offsetof(CPUX86State,xmm_regs[reg].ZMM_Q(0)));
                    break;
                }else{
                    tcg_gen_ld32u_tl(s->T0, cpu_env, op2_offset + (val & 3) * 4);
                    tcg_gen_ld32s_tl(s->T1, cpu_env, op2_offset + ((val >> 2) & 3) * 4);
                    tcg_gen_ld32u_tl(s->tmp1_i64, cpu_env, op2_offset + ((val >> 4) & 3) * 4);
                    tcg_gen_ld32s_tl(s->A0, cpu_env, op2_offset + ((val >> 6) & 3) * 4);

                    tcg_gen_shli_tl(s->T1, s->T1, 32);
                    tcg_gen_or_tl(s->T0, s->T0, s->T1);
                    tcg_gen_st_tl(s->T0, cpu_env, op1_offset);
                    tcg_gen_shli_tl(s->A0, s->A0, 32);
                    tcg_gen_or_tl(s->A0, s->A0, s->tmp1_i64);
                    tcg_gen_st_tl(s->A0, cpu_env, op1_offset + 8);
                    break;
                }
           }
        ...
        case 0xf7:
            ...
            break;
        default:
#if defined(CONFIG_FUNC_OPT) && defined(__sw_64__)//tianx
            para_same = (op1_offset==op2_offset)? true : false;
            operation = func_opt_1(s, b, b1, para_same, op1_offset, op2_offset);

            if(!operation){
                tcg_gen_addi_ptr(s->ptr0, cpu_env, op1_offset);
                tcg_gen_addi_ptr(s->ptr1, cpu_env, op2_offset);
                sse_fn_epp(cpu_env, s->ptr0, s->ptr1);//gaoqing
            }
#else
            tcg_gen_addi_ptr(s->ptr0, cpu_env, op1_offset);
            tcg_gen_addi_ptr(s->ptr1, cpu_env, op2_offset);
...
#if defined(CONFIG_PUSH_OPT) && defined(__sw_64__)
    MemOp d_ot, a_ot;
#endif
 ...
 reswitch:
...
#if defined(CONFIG_PUSH_OPT) && defined(__sw_64__)
       a_ot = mo_stacksize(s);
       if(CODE64(s) && a_ot == MO_64) {
           d_ot = mo_pushpop(s, s->dflag);
           tcg_gen_subi_tl(cpu_regs[R_ESP], cpu_regs[R_ESP], 1 << d_ot);
           gen_op_st_v(s, d_ot, s->T0, cpu_regs[R_ESP]);
       }else{
           gen_push_v(s, s->T0);
       }
#else
    ...
    do_btx:
        ...
        if (mod != 3) {
  	    ...
  	    bool s8 = ot == 3 ? 1 : 0;
	    if (s4) {
		tcg_gen_s4addl_i64(s->A0, s->tmp0, gen_lea_modrm_1(s, a));
	    } else if (s8){
		tcg_gen_s8addl_i64(s->A0, s->tmp0, gen_lea_modrm_1(s, a));
	    } else {
...
void tcg_x86_init(void)
{
...
#if defined(CONFIG_REG_OPT) && defined(__sw_64__)
    cpu_regs[R_ESI] = tcg_set_regs(TCG_REG_X10, reg_names[R_ESI]);
    cpu_regs[R_EDI] = tcg_set_regs(TCG_REG_X11, reg_names[R_EDI]);
    cpu_regs[R_EAX] = tcg_set_regs(TCG_REG_X12, reg_names[R_EAX]);
    cpu_regs[R_ECX] = tcg_set_regs(TCG_REG_X13, reg_names[R_ECX]);
    cpu_regs[R_EDX] = tcg_set_regs(TCG_REG_X14, reg_names[R_EDX]);
    cpu_regs[R_ESP] = tcg_set_regs(TCG_REG_X8, reg_names[R_ESP]);

    cpu_regs[R_EBX] = tcg_global_mem_new(cpu_env,
        offsetof(CPUX86State, regs[R_EBX]),
        reg_names[R_EBX]);
    cpu_regs[R_EBP] = tcg_global_mem_new(cpu_env,
                                    offsetof(CPUX86State, regs[R_EBP]),
                                    reg_names[R_EBP]);
    for (i = 8; i < 12; ++i) {
    ...
    cpu_regs[12] = tcg_set_regs(TCG_REG_X6, reg_names[12]);
    cpu_regs[13] = tcg_set_regs(TCG_REG_X7, reg_names[13]);
    for (i = 14; i < CPU_NB_REGS; ++i) {
        cpu_regs[i] = tcg_global_mem_new(cpu_env,
                                     offsetof(CPUX86State, regs[i]),
                                     reg_names[i]);
    }
...
#if defined(CONFIG_FUNC_OPT) && defined(__sw_64__)
    dc->vec128 = tcg_temp_new_vec(TCG_TYPE_V128);
    dc->f64 = tcg_temp_new_vec(TCG_TYPE_V64);
    dc->f64_1 = tcg_temp_new_vec(TCG_TYPE_V64);
    dc->f64_32 = tcg_temp_new_vec(TCG_TYPE_V64);
#endif
}

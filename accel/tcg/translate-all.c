                                     ...
                                     uintptr_t searched_pc, bool reset_icount)
{
 ...
 found:
    if (reset_icount && (tb_cflags(tb) & CF_USE_ICOUNT)) {
        ...
        cpu_neg(cpu)->icount_decr.u32.low += num_insns - i;
    }
...
static void do_tb_phys_invalidate(TranslationBlock *tb, bool rm_from_page_list)
{
    ...
    rfich_log_tb_invalidate(tb->hyperchain_target_count);
#endif
 ...
 * Called via accel/tcg/cputlb.c when code areas are written to with
 ...
 *
 * Called by accel/tcg/cputlb.c, with iothread mutex not held.
 */
void cpu_io_recompile(CPUState *cpu, uintptr_t retaddr)
{
    ...
    if (cc->tcg_ops->io_recompile_replay_branch &&
        ...
        cpu_neg(cpu)->icount_decr.u32.low++;
        n = 2;
    }
...
void cpu_interrupt(CPUState *cpu, int mask)
{
    ...
    qatomic_set(&cpu_neg(cpu)->icount_decr.u32.high, -1);
}

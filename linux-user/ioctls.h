     ...
     IOCTL(MPT3EVENTQUERY, 0, TYPE_INT)
     IOCTL(MPT3EVENTENABLE, 0, TYPE_INT)
     IOCTL(MPT3EVENTREPORT, 0, TYPE_INT)
     IOCTL(MPT3HARDRESET, 0, TYPE_INT)
     IOCTL(MPT3BTDHMAPPING, 0, TYPE_INT)

     IOCTL(MPT3DIAGREGISTER, 0, TYPE_INT)
     IOCTL(MPT3DIAGRELEASE, 0, TYPE_INT)
     IOCTL(MPT3DIAGUNREGISTER, 0, TYPE_INT)
     IOCTL(MPT3DIAGQUERY, 0, TYPE_INT)
     IOCTL(MPT3DIAGREADBUFFER, 0, TYPE_INT)
  ...
  /*trustrcli tools*/
  IOCTL(CCISS_PASSTHRU, 0, TYPE_INT)
  IOCTL(CCISS_GETPCIINFO, 0, TYPE_INT)
  IOCTL(LINUX_SG_GET_VERSION_NUM, 0, TYPE_INT)
  IOCTL(LINUX_SG_IO, 0, TYPE_INT)
  ...
  IOCTL(CH34x_GET_DRV_VERSION, IOC_R, MK_PTR(MK_ARRAY(TYPE_CHAR, 16)))
  IOCTL(CH34x_CHIP_VERSION, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(CH34x_CHIP_TYPE, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(CH34x_CHIP_ID, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(CH34x_FUNCTION_SETPARA_MODE, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_FUNCTION_READ_MODE, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_FUNCTION_WRITE_MODE, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_SET_TIMEOUT, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_PIPE_DATA_READ, IOC_RW, MK_PTR(TYPE_INT))
  IOCTL(CH34x_PIPE_DATA_WRITE, IOC_RW, MK_PTR(TYPE_INT))
  IOCTL(CH34x_PIPE_WRITE_READ, IOC_RW, MK_PTR(MK_ARRAY(TYPE_CHAR, 32)))
  IOCTL(CH34x_PIPE_DEVICE_CTRL, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_START_BUFFERED_UPLOAD, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_STOP_BUFFERED_UPLOAD, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_QWERY_SPISLAVE_FIFO, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(CH34x_RESET_SPISLAVE_FIFO, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_READ_SPISLAVE_FIFO, IOC_R, MK_PTR(TYPE_INT))
  IOCTL(CH34x_START_IRQ_TASK, IOC_W, MK_PTR(TYPE_INT))
  IOCTL(CH34x_STOP_IRQ_TASK, IOC_W, MK_PTR(TYPE_INT))

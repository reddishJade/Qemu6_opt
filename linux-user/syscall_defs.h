...
/*
 *  mpt3sas ioctls opcodes according to linux kernel source code. 
 *  */
#define __user         __attribute__((noderef, address_space(1)))
#define MPT3_MAGIC_NUMBER       'L'

/* MPT3IOCINFO  _IOC(_IOC_READ|_IOC_WRITE, 0x4c, 0x11, 0x5c)  0xc05c4c11 */
#define TARGET_MPT3IOCINFO		   _IOWR(MPT3_MAGIC_NUMBER, 17, \
	       	struct mpt3_ioctl_iocinfo)
#define MPT3IOCINFO			   _IOWR(MPT3_MAGIC_NUMBER, 17, \
		struct mpt3_ioctl_iocinfo)

/* MPT3COMMAND  _IOC(_IOC_READ|_IOC_WRITE, 0x4c, 0x14, 0x48)  0xc0484c14 */
#define TARGET_MPT3COMMAND		   _IOWR(MPT3_MAGIC_NUMBER, 20, \
		struct mpt3_ioctl_command)
#define MPT3COMMAND			   _IOWR(MPT3_MAGIC_NUMBER, 20, \
		struct mpt3_ioctl_command)

/* MPT3EVENTQUERY  _IOC(_IOC_READ|_IOC_WRITE, 0x4c, 0x15, 0x20)  0xc0204c15 */
#define TARGET_MPT3EVENTQUERY  _IOWR(MPT3_MAGIC_NUMBER, 21, \
        struct mpt3_ioctl_eventquery)
#define MPT3EVENTQUERY  _IOWR(MPT3_MAGIC_NUMBER, 21, \
        struct mpt3_ioctl_eventquery)

/* MPT3EVENTENABLE  0xc01c4c16 */
#define TARGET_MPT3EVENTENABLE _IOWR(MPT3_MAGIC_NUMBER, 22, \
        struct mpt3_ioctl_eventenable)
#define MPT3EVENTENABLE _IOWR(MPT3_MAGIC_NUMBER, 22, \
        struct mpt3_ioctl_eventenable)

/* MPT3EVENTREPORT  _IOC(_IOC_READ|_IOC_WRITE, 0x4c, 0x17, 0xd4)  0xc0d44c17 */
#define TARGET_MPT3EVENTREPORT _IOWR(MPT3_MAGIC_NUMBER, 23, \
        struct mpt3_ioctl_eventreport)
#define MPT3EVENTREPORT _IOWR(MPT3_MAGIC_NUMBER, 23, \
        struct mpt3_ioctl_eventreport)

/* MPT3HARDRESET  0xc00c4c18 */
#define TARGET_MPT3HARDRESET   _IOWR(MPT3_MAGIC_NUMBER, 24, \
        struct mpt3_ioctl_diag_reset)
#define MPT3HARDRESET   _IOWR(MPT3_MAGIC_NUMBER, 24, \
        struct mpt3_ioctl_diag_reset)

/* MPT3BTDHMAPPING 0xc0184c1f */
#define TARGET_MPT3BTDHMAPPING _IOWR(MPT3_MAGIC_NUMBER, 31, \
        struct mpt3_ioctl_btdh_mapping)
#define MPT3BTDHMAPPING _IOWR(MPT3_MAGIC_NUMBER, 31, \
        struct mpt3_ioctl_btdh_mapping)

/* MPT3DIAGREGISTER 0xc0784c1a */
#define TARGET_MPT3DIAGREGISTER _IOWR(MPT3_MAGIC_NUMBER, 26, \
        struct mpt3_diag_register)
#define MPT3DIAGREGISTER _IOWR(MPT3_MAGIC_NUMBER, 26, \
        struct mpt3_diag_register)

/* MPT3DIAGRELEASE 0xc0104c1b */
#define TARGET_MPT3DIAGRELEASE _IOWR(MPT3_MAGIC_NUMBER, 27, \
        struct mpt3_diag_release)
#define MPT3DIAGRELEASE _IOWR(MPT3_MAGIC_NUMBER, 27, \
        struct mpt3_diag_release)

/* MPT3DIAGUNREGISTER 0xc0104c1c */
#define TARGET_MPT3DIAGUNREGISTER _IOWR(MPT3_MAGIC_NUMBER, 28, \
        struct mpt3_diag_unregister)
#define MPT3DIAGUNREGISTER _IOWR(MPT3_MAGIC_NUMBER, 28, \
        struct mpt3_diag_unregister)

/* MPT3DIAGQUERY 0xc07c4c1d */
#define TARGET_MPT3DIAGQUERY   _IOWR(MPT3_MAGIC_NUMBER, 29, \
        struct mpt3_diag_query)
#define MPT3DIAGQUERY   _IOWR(MPT3_MAGIC_NUMBER, 29, \
        struct mpt3_diag_query)

/* MPT3DIAGREADBUFFER  0xc0204c1e */
#define TARGET_MPT3DIAGREADBUFFER _IOWR(MPT3_MAGIC_NUMBER, 30, \
...
#define TARGET_CCISS_PASSTHRU           0xc058420b
#define CCISS_GETPCIINFO                0x80084201
#define TARGET_CCISS_GETPCIINFO         0x80084201
#define TARGET_LINUX_SG_GET_VERSION_NUM 0x2282
#define LINUX_SG_GET_VERSION_NUM        0x2282
#define TARGET_LINUX_SG_IO              0x2285
#define LINUX_SG_IO                     0x2285
...
#define TARGET_MAP_EXECUTABLE  0x04000     /* mark it as an executable */
#define TARGET_MAP_LOCKED  0x08000     /* lock the mapping */
#define TARGET_MAP_NORESERVE   0x10000     /* don't check for reservations */
#define TARGET_MAP_POPULATE    0x20000     /* populate (prefault) pagetables */
#define TARGET_MAP_NONBLOCK    0x40000     /* do not block on IO */
...
#define TARGET_CH34x_GET_DRV_VERSION       TARGET_IOR(IOCTL_MAGIC, 0x80, u16)
#define TARGET_CH34x_CHIP_VERSION          TARGET_IOR(IOCTL_MAGIC, 0x81, u16)
#define TARGET_CH34x_CHIP_TYPE             TARGET_IOR(IOCTL_MAGIC, 0x82, u16)
#define TARGET_CH34x_CHIP_ID               TARGET_IOR(IOCTL_MAGIC, 0x83, u16)
#define TARGET_CH34x_FUNCTION_SETPARA_MODE TARGET_IOW(IOCTL_MAGIC, 0x90, u16)
#define TARGET_CH34x_FUNCTION_READ_MODE    TARGET_IOW(IOCTL_MAGIC, 0x91, u16)
#define TARGET_CH34x_FUNCTION_WRITE_MODE   TARGET_IOW(IOCTL_MAGIC, 0x92, u16)
#define TARGET_CH34x_SET_TIMEOUT           TARGET_IOW(IOCTL_MAGIC, 0x93, u16)
#define TARGET_CH34x_PIPE_DATA_READ        TARGET_IOWR(IOCTL_MAGIC, 0xb0, u16)
#define TARGET_CH34x_PIPE_DATA_WRITE       TARGET_IOWR(IOCTL_MAGIC, 0xb1, u16)
#define TARGET_CH34x_PIPE_WRITE_READ       TARGET_IOWR(IOCTL_MAGIC, 0xb2, u16)
#define TARGET_CH34x_PIPE_DEVICE_CTRL      TARGET_IOW(IOCTL_MAGIC, 0xb3, u16)
#define TARGET_CH34x_START_BUFFERED_UPLOAD TARGET_IOW(IOCTL_MAGIC, 0xb4, u16)
#define TARGET_CH34x_STOP_BUFFERED_UPLOAD  TARGET_IOW(IOCTL_MAGIC, 0xb5, u16)
#define TARGET_CH34x_QWERY_SPISLAVE_FIFO   TARGET_IOR(IOCTL_MAGIC, 0xb6, u16)
#define TARGET_CH34x_RESET_SPISLAVE_FIFO   TARGET_IOW(IOCTL_MAGIC, 0xb7, u16)
#define TARGET_CH34x_READ_SPISLAVE_FIFO    TARGET_IOR(IOCTL_MAGIC, 0xb8, u16)
#define TARGET_CH34x_START_IRQ_TASK        TARGET_IOW(IOCTL_MAGIC, 0xc0, u16)
#define TARGET_CH34x_STOP_IRQ_TASK         TARGET_IOW(IOCTL_MAGIC, 0xc1, u16)
